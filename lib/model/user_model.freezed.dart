...
abstract class $UsersModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String email, String phone, String moto});
}
...
class _$_UsersModel implements _UsersModel {
  ...
  @override
  String toString() {
    return 'UsersModel(name: $name, email: $email, phone: $phone, moto: $moto)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, email, phone, moto);
...
abstract class _UsersModel implements UsersModel {
  const factory _UsersModel(
      ...
      required final String moto}) = _$_UsersModel;
